...
" e.i., std::string will be highlighted green
"highlight cNamespace ctermfg=green cterm=Italic
"call matchadd('cNamespace', '\w*::\w*')
...
hi! link Statement DraculaCyan
hi! link Conditional DraculaCyan
hi! link Repeat DraculaCyan
hi! link Label DraculaCyan
hi! link Operator DraculaCyan
hi! link Keyword DraculaCyan
hi! link Exception DraculaCyan

hi! link PreProc DraculaCyan
hi! link Include DraculaPink
hi! link Define DraculaCyan
hi! link Macro DraculaCyan
hi! link PreCondit DraculaCyan
hi! link StorageClass DraculaCyan
hi! link Structure DraculaCyan
hi! link Typedef DraculaCyan
